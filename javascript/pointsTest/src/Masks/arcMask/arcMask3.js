...
class arcMask3 extends MaskBase {
	//------------------------------------------
	setup() {
		super.addLayer();
		this.name = "arcMask3";
		this.eyeL = new arcGrid3({
			row: 2,
			column: 2,
			radius: 50,
			combination: [
